...
import TrustStep1 from '../../static/assets/gifs/truststep1.gif'
import TrustStep2 from '../../static/assets/gifs/truststep2.gif'
import TrustStep3 from '../../static/assets/gifs/truststep3.gif'
import TrustStep4 from '../../static/assets/gifs/truststep4.gif'
import TrustStep5 from '../../static/assets/gifs/truststep5.gif'
import TrustStep6 from '../../static/assets/gifs/truststep6.gif'
        ...
        <Row className="how-to-video-wrapper">
          ...
          <Row>
            <Col className="button-wrapper">
                <Button className="wallet-button" onClick={() => setTrust(true)}>GET STARTED WITH TRUST WALLET</Button>
            </Col>
            <Col className="button-wrapper">
                <Button className="wallet-button"  onClick={() => setMeta(true)}>GET STARTED WITH METAMASK</Button>
            </Col>
          </Row>
          <Tabs defaultActiveKey="profile" className="trust-wallet-steps mb-3">
            <Tab eventKey="Step1" title="Step 1">
              <img className="truststep"src={TrustStep1}></img>
            ...
            <Tab eventKey="Step2" title="Step 2">
              <img className="truststep"src={TrustStep2}></img>
              <div className="instructions">
            ...
            <Tab eventKey="Step3" title="Step 3">
              <img className="truststep"src={TrustStep3}></img>
              <div className="instructions">
            ...
            <Tab eventKey="Step4" title="Step 4">
              <img className="truststep"src={TrustStep4}></img>
              <div className="instructions">
            ...
            <Tab eventKey="Step5" title="Step 5">
              <img className="truststep"src={TrustStep5}></img>
              <div className="instructions">
                ...
                <p>In the lower “to” field, you’ll need to click “select a currency” and then search for $YUMMY by pasting in this token contract code: 0x05f2df7b3d612a23fe12162a6c996447dce728a5</p>
            ...
            <Tab eventKey="Step6" title="Step 6">
              <img className="truststep"src={TrustStep6}></img>
              <div className="instructions">
